...
> = {
  bkash: {
    number: "01700000000",
    instructions:
      "Send money to this bKash number. Use your transaction ID as reference.",
  },
  nagad: {
    number: "01700000000",
    instructions:
      "Send money to this Nagad number. Use your transaction ID as reference.",
  },
  bank_transfer: {
    ...
    routing: "BRAC-0001",
    instructions:
      "Send money to the above account. Include your transaction ID in the transfer note.",
  },
};
        ...
        {selectedPlan && (
          <div>
            ...
            <p className="text-sm text-slate-600 mb-4">
              Pay via bKash, Nagad, or Bank Transfer. Admin will approve within
              24 hours.
            </p>
            <div className="grid gap-4 sm:grid-cols-3">
              {PAYMENT_METHODS.map((pm) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-12 h-12 rounded-lg ${pm.color} flex items-center justify-center`}
                    >
                    ...
                    <span
                      className={`w-4 h-4 rounded-full border-2 flex items-center justify-center shrink-0 ${paymentMethod === pm.id ? "border-[#1e3a5f] bg-[#1e3a5f]" : "border-slate-300"}`}
                    >
                      {paymentMethod === pm.id && (
                  ...
                  <div className="flex justify-between items-center py-2 border-b border-slate-100">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          copyToClipboard(details.number!, "Number")
                        }
        ...
        {myPayments.length > 0 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track your payment status. Admin will approve within 24 hours.
              </CardDescription>
            </CardHeader>
